...
const gpServices = [
  {
    ...
    description: "Our team of Family Physicians and General Practitioners provides medical care to patients of all ages.",
    image: "/images/gp-services/gp-service1.webp",
    href: "/services/gp/general-consultation",
  },
  {
    title: "Chronic Disease Management",
    description: "Ongoing care and monitoring for conditions like diabetes, hypertension, and asthma.",
    image: "/images/gp-services/gp-service3.webp",
    href: "/services/gp/chronic-disease-management",
  },
  {
    title: "Vaccinations",
    description: "Recommended vaccines for all ages, including travel and seasonal flu jabs.",
    image: "/images/gp-services/gp-service2.png",
    href: "/services/gp/vaccinations",
  },
];

export default function GPServicesSection() {
    ...
    <section className="bg-white py-20 overflow-hidden relative">
      <div className="absolute top-0 left-0 w-[88%] h-[520px] z-0 pointer-events-none">
        <svg viewBox="0 0 1200 520" preserveAspectRatio="none" className="w-full h-full">
          <path
            d="M0 0 H1000 C1150 0 1200 80 1200 160 V520 H0 Z"
            fill="#f4f7ff"
          />
        </svg>
      </div>
